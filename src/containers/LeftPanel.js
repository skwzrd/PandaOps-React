...
export default function LeftPanel(props) {
  const [info, setInfo] = useState([]);
    ...
    }, [props.fetched_rows, props.name, props.names, props.duplicates, props.duplicates_count, props.duplicates_index, props.cmd, props.data]);// eslint-disable-line react-hooks/exhaustive-deps
